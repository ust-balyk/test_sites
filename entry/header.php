    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="<?= base_url('/home'); ?>">
                <img class="brand" src="<?= base_url(POCKET_STYLE .'/favicon/admin.png'); ?>"
                    style="height:3.5rem;margin-left:1.05rem" alt="Logo">
            </a>
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3">
                    <a href="./profile.php" class="d-flex">
                        <div class="image">
                        <img src="<?= base_url(POCKET_STYLE .'/favicon/user.png'); ?>"
