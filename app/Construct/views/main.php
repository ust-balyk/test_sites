  ...
  <!--section>
    <div class="container description">
      <div class="category_description clearfix">
        ...
        <p>Потребители всего мира задаются вопросом, зачем японцы производят так много
            продуктов для поддержания здоровья, молодости и красоты?
          Что такое японская система ухода за кожей, в чем ее секрет?
          Что именно им нужно приобрести и в какой последовательности пользоваться?</p>
        <p>Средняя продолжительность жизни в Японии — более 90 лет. А встретив на улице пожилую японку,
          ...
          система ухода за кожей лица состоит из следующих этапов:</p>
        <ul>
          <li>очищение от макияжа и загрязнений;</li>
          <li>обязательный пилинг зависит от типа кожи и возраста;</li>
          <li>нормализация PH-баланса с помощью лосьона;</li>
          <li>осветление и выравнивание тона сывороткой;</li>
          <li>увлажнение и питание маской для лица;</li>
          <li>тонизирующий массаж с косметическим маслом;</li>
          <li>стабилизирующий крем.</li>
        </ul>
  ...
  <section>
    <div class="container d-none d-md-block">
      ...
      <h4 style="text-align:center;">Почему японская косметика ценится во всём мире?</h4>
      <p>Японская косметика занимает особое место на мировом рынке товаров для поддержания здоровья, молодости и красоты, и ее ценность признана экспертами и потребителями от Парижа до Нью-Йорка. Этот успех не случайность, но закономерный результат уникального сплава нескольких фундаментальных факторов. Это целая философия, основанная на вековых традициях и самых современных технологиях. Сегодня японские косметические средства - это синтез научных исследований, стремления к совершенству и гармонии с окружающей средой. Именно поэтому глобальный рынок японской косметологии исчисляется миллиардами долларов.</p>
      <ol>
	    <li><strong>Наследие многовековых традиций и ритуальный подход.</strong> В основе лежит древняя философия ухода, отточенная веками. Ритуалы красоты гейш, которые тратили часы на уход за кожным покровом с использованием натуральных экстрактов (рис, адзуки, зеленый чай), стали прототипом современных многоступенчатых рутин. Для японок уход это не быстрая процедура, а ежедневный ритуал, направленный на восстановление и поддержание баланса.</li>
	    <li><strong>Культ безупречного качества и бескомпромиссные стандарты.</strong> Японцы известны своим перфекционизмом. Этот принцип &laquo;моно-но аварэ&raquo; (очарование вещей) распространяется и на косметику. На каждом этапе от отбора ингредиентов до упаковки действуют жесткие стандарты. Многие бренды имеют собственные исследовательские центры (как Shiseido), где десятилетиями изучают клетки кожи и механизмы старения. Флакон или баночка это не просто тара, а часть опыта. Дизайн продуман до мелочей: дозаторы, которые не забиваются, текстуры, которые приятно наносить, запахи, не перегруженные отдушками.</li>
	    <li><strong>Передовая наука и инновационные технологии.</strong> Япония - мировой лидер в высоких технологиях, и это напрямую отражается в косметологии. Бренды тесно сотрудничают с учеными и косметологами, создавая средства, которые действительно работают на биохимическом уровне, стимулируя естественные процессы (например, выработку собственного коллагена).</li>
	    <li><strong>Бережная эффективность: принцип &laquo;не навреди&raquo;. </strong>Формулы создаются с минимальным содержанием потенциальных раздражителей (спирт, агрессивные ПАВы, сильные отдушки). Поэтому японские средства часто рекомендуют для чувствительной кожи.</li>
	    <li><strong>Уникальные натуральные ингредиенты.</strong> Япония - страна с богатой флорой и особыми природными ресурсами, которые активно используются в составах:</li>
        <ul class="fa-ul">
	      <li><i class="fa-li fa fa-check-square"></i>Рисовые отруби и ферменты для мягкого очищения, осветления и придания сияющего блеска.</li>
	      <li><i class="fa-li fa fa-check-square"></i>Зеленый чай (матча) мощный антиоксидант для защиты от свободных радикалов.</li>
	      <li><i class="fa-li fa fa-check-square"></i>Морские водоросли (комбу, нори) источник минералов для интенсивного увлажнения и питания.</li>
	      <li><i class="fa-li fa fa-check-square"></i>Экстракт шелковицы - для борьбы с пигментными пятнами. Эти природные компоненты работают в сочетании с высокотехнологичными синтезированными веществами, создавая синергетический эффект.</li>
        </ul>
	    <li><strong>Ориентация на профилактику, а не на коррекцию. </strong>Японки начинают ухаживать за кожей очень рано, часто с подросткового возраста, делая акцент на увлажнении и защите от солнца. Поэтому японская косметика предлагает огромный ассортимент легких эссенций, лосьонов, увлажняющих гелей. Это проактивный подход, который позволяет сохранить молодость кожного покрова на долгие годы, предотвращая проблемы, а не борясь с их последствиями.</li>
      </ol>
