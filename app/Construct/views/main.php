  ...
  <section class="post">
    <div class="container d-none d-md-block">
      <!--h5 style="text-align:center;">Почему японская косметика?</h5>
      <p>Японская философия красоты основана на бережном отношении к коже и профилактике возрастных изменений. 
        Косметика из Японии отличается:</p>
      <ol>
	    <li><strong>Натуральными формулами</strong> с высокой концентрацией активных компонентов</li>
	    <li><strong>Инновационными технологиями</strong> производства и упаковки</li>
	    <li><strong>Деликатным воздействием</strong> даже на чувствительную кожу</li>
	    <li><strong>Доказанной эффективностью</strong> и строгим контролем качества</li>
      </ol>
      <h5 style="text-align:center;" >Японские витамины — забота о здоровье изнутри!</h5>
      <p>Витаминные комплексы из Японии созданы с учетом потребностей современного человека. 
        Они помогают поддерживать иммунитет, улучшают состояние кожи, волос и ногтей, 
        повышают энергию и общий тонус организма.</p-->
      <!--p><strong>В нашем магазине вы найдете тщательно отобранные продукты от проверенных 
        японских производителей. 
        Мы гарантируем оригинальность товаров и предлагаем подробные консультации по выбору средств, 
