...
<?php dump($_COOKIE); ?>
  ...
  <!--section class="post">
    <div class="container d-none d-md-block">
      ...
      <p>Японская косметика занимает особое место на мировом рынке товаров для поддержания здоровья, молодости и красоты. Её ценность признана экспертами и потребителями от Парижа до Нью-Йорка. Этот успех - не случайность, но закономерный результат уникального сплава нескольких фундаментальных факторов. Это целая философия, основанная на вековых традициях и самых современных технологиях. Сегодня японские косметические средства - это синтез научных исследований, стремления к совершенству и гармонии с окружающей средой. Именно поэтому глобальный рынок японской косметологии исчисляется миллиардами долларов.</p>
      <ol>
	    <li><strong>Наследие многовековых традиций и ритуальный подход.</strong> В основе всего лежит концепция потребности в превосходстве. Ритуалы красоты гейш, которые тратили часы на уход за кожным покровом с использованием натуральных экстрактов (рис, адзуки, зеленый чай), стали прототипом современных многоступенчатых практик. Для японок забота о собственном теле - это не скорая процедура, а ежедневный тщательный ритуал, направленный на   поддержание уверенности и любви к себе.</li>
	    <li><strong>Культ безупречного качества и бескомпромиссные стандарты.</strong> Японцы известны своим перфекционизмом. Этот принцип распространяется и на косметику.&ensp; На каждом этапе от отбора ингредиентов до упаковки действуют жесткие стандарты. Многие бренды имеют собственные исследовательские центры (как Shiseido), где десятилетиями изучают клетки кожи и механизмы старения. Флакон или баночка это не просто тара, а часть опыта. Дизайн продуман до мелочей: дозаторы, которые не забиваются, текстуры, которые приятно наносить, запахи, не перегруженные отдушками.</li>
	    <li><strong>Передовая наука и инновационные технологии.</strong> Япония - мировой лидер в высоких технологиях, и это напрямую отражается в косметологии. Бренды тесно сотрудничают с учеными и косметологами, создавая средства, которые действительно работают на биохимическом уровне, стимулируя естественные процессы регенерации организма (например, выработку собственного коллагена).</li>
