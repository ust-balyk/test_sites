...
<html lang="ru" class="notranslate">
    ...
    <body style="background-color: #fffffd;">
        ...
        <div class="container general_terms" style="margin-top: 10px;">
            <a href="#" id="_delivery" class="btn btn-outline-primary">
                <h6>назад</h6>
            </a>
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    var go_back = document.getElementById("_delivery");
            ...
            <div class="block" style="margin-top: 10px">
                ...
                Стоимость и сроки доставки рассчитываются автоматически и соответствуют тарифам перевозчика.
                    ...
                    <ul>
                        ...
                        пожалуйста, свяжитесь с нами для согласования способа доставки.
                        </li>
                    </ul>
                </p>
            ...
            <div style="text-align: right">
                <a href="#" id="delivery_" class="btn btn-outline-primary" style="margin-top: 10px">
                    <h6>назад</h6>
                </a>
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        var go_back = document.getElementById("delivery_");
                        go_back.addEventListener("click", function() {
                            window.location.href = localStorage.getItem('location');
                        });
                    });
