  <section class="superiority">
    <div class="container">
      <div class="row">
        <h3 class="mt-3 mb-2 header_post">
          Добро пожаловать в мир красоты, проверенный временем, на Japan-in.Ru!</h3><br>
        <h5 style="margin: 0px 0px 100px 0px; padding: 0px;">
          У нас вы найдёте подлинную японскую косметику &ndash; слияние инновационных достижений науки 
          и вековых традиций качества. Каждое средство, это полноценный продукт вдохновлённый природой, 
          духом дзэн и безупречным японским мастерством.<br>
          Пусть каждый день начинается с маленького ритуала, который наполняет тебя уверенностью и 
          внутренним равновесием выражаясь в сиянии очарования.</h5>
